	...
	<div class="wrap">
		<div class="body">
			...
			?>
				...
				<div onclick="showSystemRequirements();" style="cursor:pointer;"><?php echo esc_html_e( 'Show System Requirements', 'tm-molly' );?></div>
				...
				<div class="tm-demo-source-container">
					<?php foreach ( $demos as $demo_id => $demo ) : ?>
						<form class="tm-demo-source" id="<?php echo esc_attr( $demo_id ); ?>" method="post" action=""
